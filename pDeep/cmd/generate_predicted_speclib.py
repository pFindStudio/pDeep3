...
if __name__ == "__main__":
    ...
    parser.add_argument('--tune_psm', type=str, required=False, help='.osw (OpenSWATH), .elib (EncyclopDIA), evidence.txt (MaxQuant) or Filtered.spectra (pFind) file for tuning pDeep and pDeepRT.')
    ...
    def _from_fasta(_seqlib, fasta, proteins = None):
        if proteins:
            ...
            protein_list = None
        peptide_list, protein_dict = _seqlib.PeptideListFromFasta(args.input, protein_list)
