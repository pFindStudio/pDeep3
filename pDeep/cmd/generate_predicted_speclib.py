...
if __name__ == "__main__":
    ...
    parser.add_argument('--spikein_varmod', type=str, default="", required=False, help='Variable modifications within spike-in peptides, seperated by ","')
    parser.add_argument('--spikein_fixmod', type=str, default="", required=False, help='Variable modifications within spike-in peptides, seperated by ","')
    ...
    parser.add_argument('--tune_psm', type=str, required=False, help='.osw (OpenSWATH), .elib (EncyclopDIA), evidence.txt (MaxQuant), .spectra (pFind) or .txt (tab seperated file with title "scan, " file for tuning pDeep and pDeepRT.')
