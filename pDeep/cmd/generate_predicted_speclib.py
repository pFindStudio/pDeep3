...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_mod', type=str, default="", required=False, help='Only peptides with PTM specified here are kept, default: "", seperated by ",".')
    parser.add_argument('--target_mod_min', type=int, default=0, required=False, help="Peptides with >= n target modifications are kept, default: n=0.")
    parser.add_argument('--target_mod_max', type=int, default=0, required=False, help="Peptides with <= n target modifications are kept, default: n=0.")
    ...
    parser.add_argument('--max_miss_cleave', type=int, default=2, required=False, help='Max number of miss cleave sites')
    ...
    parser.add_argument('--RT_model', type=str, required=False, default='', help='Retention time prediction model, default: pDeep build-in model')
    ...
    seqlib = SequenceLibrary(min_charge = args.min_precursor_charge, 
                             ...
                             target_mod_min=args.target_mod_min, target_mod_max=args.target_mod_max,
                             max_miss_cleave=args.max_miss_cleave)
    ...
    print("[pDeep Info] target modifications included: '%s'"%args.target_mod)
