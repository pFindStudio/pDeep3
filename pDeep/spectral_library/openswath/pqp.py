...
class PQP(LibraryBase):
    ...
    def CreateTables(self):
        self.cursor.execute("CREATE TABLE COMPOUND(ID INT PRIMARY KEY NOT NULL,COMPOUND_NAME TEXT NOT NULL,SUM_FORMULA TEXT NOT NULL,SMILES TEXT NOT NULL,ADDUCTS TEXT NOT NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE GENE(ID INT PRIMARY KEY NOT NULL,GENE_NAME TEXT NOT NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PEPTIDE(ID INT PRIMARY KEY NOT NULL,UNMODIFIED_SEQUENCE TEXT NOT NULL,MODIFIED_SEQUENCE TEXT NOT NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PEPTIDE_GENE_MAPPING(PEPTIDE_ID INT NOT NULL,GENE_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PEPTIDE_PROTEIN_MAPPING(PEPTIDE_ID INT NOT NULL,PROTEIN_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PRECURSOR(ID INT PRIMARY KEY NOT NULL,TRAML_ID TEXT NULL,GROUP_LABEL TEXT NULL,PRECURSOR_MZ REAL NOT NULL,CHARGE INT NULL,LIBRARY_INTENSITY REAL NULL,LIBRARY_RT REAL NULL,LIBRARY_DRIFT_TIME REAL NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PRECURSOR_COMPOUND_MAPPING(PRECURSOR_ID INT NOT NULL,COMPOUND_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PRECURSOR_PEPTIDE_MAPPING(PRECURSOR_ID INT NOT NULL,PEPTIDE_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE PROTEIN(ID INT PRIMARY KEY NOT NULL,PROTEIN_ACCESSION TEXT NOT NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE TRANSITION(ID INT PRIMARY KEY NOT NULL,TRAML_ID TEXT NULL,PRODUCT_MZ REAL NOT NULL,CHARGE INT NULL,TYPE CHAR(1) NULL,ANNOTATION TEXT NULL,ORDINAL INT NULL,DETECTING INT NOT NULL,IDENTIFYING INT NOT NULL,QUANTIFYING INT NOT NULL,LIBRARY_INTENSITY REAL NULL,DECOY INT NOT NULL)")
        self.cursor.execute("CREATE TABLE TRANSITION_PEPTIDE_MAPPING(TRANSITION_ID INT NOT NULL,PEPTIDE_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE TRANSITION_PRECURSOR_MAPPING(TRANSITION_ID INT NOT NULL,PRECURSOR_ID INT NOT NULL)")
        self.cursor.execute("CREATE TABLE VERSION(ID INT NOT NULL)")
        
        self.cursor.execute("INSERT INTO VERSION(ID) VALUES(3)") 
        self.cursor.execute("INSERT INTO GENE(ID,GENE_NAME,DECOY) VALUES(0,'NA',0)")
